...
<lynk-table>
    ...
    <lynk-tbody>
        ...
        <lynk-tr>
            ...
            <lynk-td state="custom" style="--state-color: var(--lynk-color-fuchsia-50);">
                Custom
            </lynk-td>
        </lynk-tr>
    </lynk-tbody>
...
<lynk-table>
    ...
    <lynk-tbody>
        ...
        <lynk-tr>
            <lynk-td>Row 6</lynk-td>
            <lynk-td state="custom" style="--state-color: var(--lynk-color-fuchsia-50); --state-color-b: var(--lynk-color-fuchsia-100);" barberpole>
                Custom
            </lynk-td>
        </lynk-tr>
    </lynk-tbody>
