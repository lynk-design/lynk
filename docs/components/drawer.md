...
To keep the drawer open in such cases, you can cancel the `l-request-close` event. When canceled, the drawer will remain open and pulse briefly to draw the user's attention to it.
