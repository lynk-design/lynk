...
LynkMenu.styles = menu_styles_default;
__decorateClass([
  i(".lynk-menu")
], LynkMenu.prototype, "menu", 2);
__decorateClass([
  i("slot")
], LynkMenu.prototype, "defaultSlot", 2);
LynkMenu = __decorateClass([
  n("lynk-menu")
], LynkMenu);
