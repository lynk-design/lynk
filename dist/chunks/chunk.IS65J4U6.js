...
var TimelineMode = /* @__PURE__ */ ((TimelineMode2) => {
  TimelineMode2[TimelineMode2["DAY"] = 0] = "DAY";
  TimelineMode2[TimelineMode2["WEEK"] = 1] = "WEEK";
  TimelineMode2[TimelineMode2["MONTH"] = 2] = "MONTH";
  return TimelineMode2;
})(TimelineMode || {});
var LynkTimeline = class extends s {
  constructor() {
    super(...arguments);
    this.dayNameFormat = "ddd";
  ...
  drop(event, week) {
    ...
    const data = (_a = event.dataTransfer) == null ? void 0 : _a.getData("text");
  ...
  async firstUpdated() {
    ...
    this.timelineRow.addEventListener("click", (e2) => {
  ...
  getSidebar() {
    ...
    for (let i2 = 0; i2 < intervals; i2++) {
      timeBreaks.push(time.toFormat(this.use24Hour ? "HH:mm" : "hh:mm A"));
  ...
  getWeek(date) {
    const day = DateTime.fromISO(date).startOf("week");
    const week = [];
    ...
    while (i2 < 7) {
      week.push({
        name: _day.toFormat(this.dayNameFormat),
        date: _day.toISO(),
        day: `${_day.day}`,
...
LynkTimeline.styles = timeline_styles_default;
__decorateClass([
  i(".lynk-timeline__row")
], LynkTimeline.prototype, "timelineRow", 2);
__decorateClass([
  e()
], LynkTimeline.prototype, "date", 2);
__decorateClass([
  e()
], LynkTimeline.prototype, "dayNameFormat", 2);
__decorateClass([
  e()
], LynkTimeline.prototype, "use24Hour", 2);
__decorateClass([
  e()
], LynkTimeline.prototype, "intervals", 2);
__decorateClass([
  e()
], LynkTimeline.prototype, "mode", 2);
LynkTimeline = __decorateClass([
  n("lynk-timeline")
], LynkTimeline);
