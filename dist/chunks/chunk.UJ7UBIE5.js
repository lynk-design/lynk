...
var CalendarMode = /* @__PURE__ */ ((CalendarMode2) => {
  CalendarMode2[CalendarMode2["DAY"] = 0] = "DAY";
  CalendarMode2[CalendarMode2["WEEK"] = 1] = "WEEK";
  CalendarMode2[CalendarMode2["MONTH"] = 2] = "MONTH";
  return CalendarMode2;
})(CalendarMode || {});
var LynkCalendar = class extends s {
  constructor() {
    super(...arguments);
    ...
    return $`
      <div role="grid">
        ...
        <div role="presentation" class="lynk-calendar__content">
          ...
          <div class="lynk-calendar__content-body horizontal-lines">
            ${week.map(() => $`
              <div class="lynk-calendar__content-body__item">
              </div>
            `)}
          </div>
        </div>
  ...
  connectedCallback() {
    ...
    this.today = (0, import_moment.default)().startOf("day");
    if (!this.date) {
      this.date = this.today;
    } else {
      this.date = (0, import_moment.default)(this.date);
    }
  }
  getHeader(week) {
    return $`
...
LynkCalendar.styles = calendar_styles_default;
__decorateClass([
  e()
], LynkCalendar.prototype, "date", 2);
__decorateClass([
  e()
], LynkCalendar.prototype, "dayNameFormat", 2);
__decorateClass([
  e()
], LynkCalendar.prototype, "use24Hour", 2);
__decorateClass([
  e()
], LynkCalendar.prototype, "interval", 2);
__decorateClass([
  e()
], LynkCalendar.prototype, "mode", 2);
LynkCalendar = __decorateClass([
  n("lynk-calendar")
], LynkCalendar);
