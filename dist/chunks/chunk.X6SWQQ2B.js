...
function l(n3) {
  const { slot: l2, selector: t2 } = n3 != null ? n3 : {};
  return o({ descriptor: (o2) => ({ get() {
    var o3;
    const r = "slot" + (l2 ? `[name=${l2}]` : ":not([name])"), i3 = (o3 = this.renderRoot) === null || o3 === void 0 ? void 0 : o3.querySelector(r), s = i3 != null ? e3(i3, n3) : [];
    return t2 ? s.filter((o4) => o4.matches(t2)) : s;
  }, enumerable: true, configurable: true }) });
}
