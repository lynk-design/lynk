...
.lynk-button {
  ...
  padding: 0;
  transition: var(--lynk-transition-x-fast) background-color, var(--lynk-transition-x-fast) color, var(--lynk-transition-x-fast) border, var(--lynk-transition-x-fast) box-shadow;
  cursor: inherit;
}
...
:host(.lynk-button-group__button:not(.lynk-button-group__button--focus, .lynk-button-group__button--first, [variant=default]):not(:hover, :active, :focus)) .lynk-button:after {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
  bottom: 0;
  border-left: solid 1px rgba(128, 128, 128, 0.33);
