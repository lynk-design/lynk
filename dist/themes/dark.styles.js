...
export default css`
  ...
  .lynk-theme-dark {
    ...
    --lynk-color-gray-50: hsl(240 5.1% 15%);
    --lynk-color-gray-100: hsl(240 5.7% 18.2%);
    --lynk-color-gray-200: hsl(240 4.6% 22%);
    --lynk-color-gray-300: hsl(240 5% 27.6%);
    --lynk-color-gray-400: hsl(240 5% 35.5%);
    --lynk-color-gray-500: hsl(240 3.7% 44%);
    --lynk-color-gray-600: hsl(240 5.3% 58%);
    --lynk-color-gray-700: hsl(240 5.6% 73%);
    --lynk-color-gray-800: hsl(240 7.3% 84%);
    --lynk-color-gray-900: hsl(240 9.1% 91.8%);
    --lynk-color-gray-950: hsl(0 0% 95%);
    ...
    --lynk-color-emerald-400: hsl(159.6 77.1% 34.3%);
    --lynk-color-emerald-500: hsl(159.1 73.5% 37.9%);
    ...
    --lynk-color-emerald-900: hsl(149.3 100% 87%);
    --lynk-color-emerald-950: hsl(158.6 100% 94.8%);
    ...
    --lynk-color-indigo-50: hsl(243.5 40.8% 27%);
    --lynk-color-indigo-100: hsl(242.9 45.7% 37.6%);
    --lynk-color-indigo-200: hsl(244.7 52.7% 43.1%);
    --lynk-color-indigo-300: hsl(245.3 60.5% 52.4%);
    --lynk-color-indigo-400: hsl(244.1 79.2% 60.4%);
    --lynk-color-indigo-500: hsl(239.6 88.7% 63.8%);
    --lynk-color-indigo-600: hsl(234.5 96.7% 70.9%);
    --lynk-color-indigo-700: hsl(229.4 100% 78.3%);
    --lynk-color-indigo-800: hsl(227.1 100% 85%);
    --lynk-color-indigo-900: hsl(223.8 100% 89.9%);
    --lynk-color-indigo-950: hsl(220 100% 95.1%);

    --lynk-color-violet-50: hsl(265.1 57.3% 25.4%);
    --lynk-color-violet-100: hsl(263.5 63.8% 39.4%);
    --lynk-color-violet-200: hsl(263.4 66.2% 44.1%);
    --lynk-color-violet-300: hsl(263.7 72.8% 52.4%);
    --lynk-color-violet-400: hsl(262.5 87.3% 59.8%);
    --lynk-color-violet-500: hsl(258.3 95.1% 63.2%);
    --lynk-color-violet-600: hsl(255.1 100% 67.2%);
    --lynk-color-violet-700: hsl(253 100% 81.5%);
    --lynk-color-violet-800: hsl(251.7 100% 87.9%);
    --lynk-color-violet-900: hsl(254.1 100% 91.7%);
    --lynk-color-violet-950: hsl(257.1 100% 96.1%);
    ...
    --lynk-color-rose-50: hsl(342.3 62.9% 21.5%);
    --lynk-color-rose-100: hsl(342.8 68.9% 34.2%);
    --lynk-color-rose-200: hsl(344.8 72.6% 37.3%);
    --lynk-color-rose-300: hsl(346.9 75.8% 43.7%);
    --lynk-color-rose-400: hsl(348.2 80.1% 52.7%);
    --lynk-color-rose-500: hsl(350.4 94.8% 57.5%);
    --lynk-color-rose-600: hsl(351.2 100% 58.1%);
    --lynk-color-rose-700: hsl(352.3 100% 78.1%);
    --lynk-color-rose-800: hsl(352 100% 86.2%);
    --lynk-color-rose-900: hsl(354.5 100% 90.7%);
    --lynk-color-rose-950: hsl(353.3 100% 95.7%);
    ...
    --lynk-color-neutral-0: hsl(240, 5.9%, 11%);
    --lynk-color-neutral-1000: hsl(0, 0%, 100%);
