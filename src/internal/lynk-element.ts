...
// event requires it)
type LynkEventInit<T> = T extends keyof GlobalEventHandlersEventMap
  ? GlobalEventHandlersEventMap[T] extends CustomEvent<Record<PropertyKey, unknown>>
    ? GlobalEventHandlersEventMap[T] extends CustomEvent<Record<PropertyKey, never>>
...
export default class LynkElement extends LitElement {
...
export interface LynkFormControl extends LynkElement {
  // Form attributes
  name: string;
  value: unknown;
  disabled?: boolean;
