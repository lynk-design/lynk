...
export { default as LynkTableCaption } from './components/table-caption/table-caption';
...
export { default as LynkTableFooterGroup } from './components/table-footer-group/table-footer-group';
