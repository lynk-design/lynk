...
describe('<lynk-switch>', () => {
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlSwitch>(html` <lynk-switch disabled></lynk-switch> `);
  ...
  it('should be valid by default', async () => {
    const el = await fixture<SlSwitch>(html` <lynk-switch></lynk-switch> `);
  ...
  it('should fire lynk-change when toggled with the left arrow', async () => {
    const el = await fixture<SlSwitch>(html` <lynk-switch checked></lynk-switch> `);
    el.focus();
