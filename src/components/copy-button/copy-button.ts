 ...
 * @documentation https://lynk.design/components/copy-button
 * @status experimental
 * @since 1.0
 *
 ...
 *
 * @event on:copy - Emitted when the data has been copied.
 * @event on:error - Emitted when the data could not be copied.
 *
 * @slot copy-icon - The icon to show in the default copy state. Works best with `<lynk-icon>`.
 * @slot success-icon - The icon to show when the content is copied. Works best with `<lynk-icon>`.
 * @slot error-icon - The icon to show when a copy error occurs. Works best with `<lynk-icon>`.
 *
...
@customElement('lynk-copy-button')
export default class LynkCopyButton extends LynkElement {
  ...
  @query('lynk-tooltip') tooltip: LynkTooltip;
  ...
  @property({ attribute: 'feedback-duration', type: Number }) feedbackDuration = 1500;
      ...
      >
        ...
        >
          <slot part="copy-icon" name="copy-icon">
            <lynk-icon library="system" name="copy"></lynk-icon>
          </slot>
          <slot part="success-icon" name="success-icon" hidden>
            <lynk-icon library="system" name="check"></lynk-icon>
          </slot>
