...
import type LynkBreadcrumbItem from '../breadcrumb-item/breadcrumb-item';

/**
 * @summary Breadcrumbs provide a group of links so users can easily navigate a website's hierarchy.
 * @documentation https://lynk.design/components/breadcrumb
 * @status stable
 * @since 1.0
 *
 * @slot - One or more breadcrumb items to display.
 * @slot separator - The separator to use between breadcrumb items. Works best with `<lynk-icon>`.
 *
...
export default class LynkBreadcrumb extends LynkElement {
